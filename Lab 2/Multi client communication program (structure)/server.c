...
int main(int argc, char* argv[]){
	...
	temp=recvfrom(fd_from,(char*)&d,n,0,(struct sockaddr*)&from,&fromlen);
	/*if(temp<0){
		printf("%d%c%f Error Recieving\n",d.a,d.b,d.c);
		exit(1);
	}*/
	
	//Making edits to data
	d.a++;
	d.b++;
	d.c-=0.5;
	printf("Sending: %d %c %f\n",d.a,d.b,d.c);
	close(fd_from);
	...
	temp=sendto(fd_to,(char*)&d,n,0,(struct sockaddr*)&to,t);
	if(temp<0){
